...
class TestStringMethods(unittest.TestCase):
    ...
    def test_errorDimensionesIncompatibles(self):
        #Ejemplo 11
        matrizA = [[(3,1),(3,0),(1,-1)],[(0,0),(0,-2),(7,-3)],[(3,0),(0,0),(1,-2)]]
        matrizB = [[(0,-1),(1,0)],[(0,0),(0,1)]]
        self.assertEqual(calculadora.multiplicacionMatrices(matrizA,matrizB),'La multiplicación de matrices no está definida para estas matrices')
